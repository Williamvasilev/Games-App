...
function welcomeUser() {
  ...
  document.getElementById('welcomeuser').innerHTML = '<p> Hello, ' + username + ', looking forward to seeing your games! Click this message to close it.</p>';
...
function getRating() {
  ...
  $(".delfolder").click(() => confirm('Really delete this folder?'))
}
